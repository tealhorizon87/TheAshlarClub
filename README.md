...
This application is designed for freemasonry and as such, the colour pallette is in line with the branding guidelines for the province of Sussex. The colour palette used to generate all colours in the project was generated by [coolors](https://coolors.co/).
![new colour pallette](assets/readme_img/new_ashlar_colour_pallette.png)
